...
public class AdoProjectManager {
  ...
  private static string GetAzureDevOpsAccessToken() {
    return EntraIdTokenManager.GetAccessTokenResult(AdoPermissionScopes).AccessToken;
  }
  ...
  public static void DeleteAllFilesInLocalGitFolder(string ProjectName) {
    string targetFolder = AppSettings.LocalGitRepoExports + ProjectName + @"\";
  ...
  public static void WriteGitFileToLocalFolder(string RepoName, string FilePath, string FileContent, bool ConvertFromBase64 = true) {
    ...
    string folderPath = AppSettings.LocalGitRepoExports + RepoName;
  ...
  public static List<GitRepoFile> GetItemsFromGitRepo(string ProjectName) {

    var gitItems = new List<GitRepoFile>();
  ...
  public static string PushContentToGitFromLocalSolutionsFolder(string ProjectName, string SolutionFolder, string LastObjectId = "0000000000000000000000000000000000000000") {
